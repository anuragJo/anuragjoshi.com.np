...
infor.innerHTML="Please verify the Captcha below."
		...
		errorDiag.style.display = "block";
		errorDiag.innerHTML='User not found! To create one goto <a style="text-decoration: none;" href="quiz_signUp.html">SignUp</a>';
...
function verifyOTP(){
  ...
  // ...
		...
		user.updatePassword(newPassword).then(() => {
			...
			errorDiag.style.display="none";
			infor.style.display = "block";
			infor.innerHTML="Password Reset!";
			...
			window.location.href="user.html";
  				...
  				// An error ocurred
			errorDiag.style.display="block";
		  errorDiag.innerHTML="Error: Password change Unsuccessful.";
		});
